...
.poison {
  background-color: rgb(179, 0, 202);
  color: white;
}
.grass {
...
.ground {
  background-color: rgb(184, 110, 0);
  color: whitesmoke;
}
.fairy {
  background-color: rgb(255, 88, 219);
  color: whitesmoke;
}
.fighting {
...
.rock {
  background-color: rgb(129, 89, 82);
  color: whitesmoke;
}
.ice {
  background-color: rgb(86, 190, 177);
  color: whitesmoke;
}
.steel {
...
.dragon {
  background-color: rgb(184, 120, 36);
  color: whitesmoke;
}
.id {
  margin: 0px;
